...
CC = o64-clang
CXX = o64-clang++
LD = x86_64-apple-darwin18-ld
AR = x86_64-apple-darwin18-ar
STDCXX = c++17
CXXFLAGS = -std=c++17 -fexceptions -frtti -pthread -fPIC
CFLAGS = -std=c17 -pthread -fPIC
LDFLAGS = -pthread -L/opt/osxcross/macports/pkgs/opt/local/libexec/llvm-14/lib
#LDFLAGS = -pthread -L/opt/osxcross/macports/pkgs/opt/local/libexec/llvm-14/lib -llibc++
LDLIBS = -lm
ARFLAGS = rcs
