...
Options:
  ...
  Build and installation options:
    ...
    --disable-vector    disable GCC vector instructions [autodetect]
  ...
  Installation prefix:
    By default, "waf install" will put the files in "/usr/local/bin", "/usr/local/lib" etc. An installation prefix
  ...
  optional features:
    ...
    --lua=LUA_VER       select Lua package to autodetect. Choices (x is 1 or 2): luadef5x, lua5x, lua5.x, lua-5.x,
                        luajit (luadef5x is for pkg-config name 'lua', the rest are exact pkg-config names)
  ...
  audio outputs:
    ...
    --disable-oss-audio
                        disable OSSv4 audio output [autodetect]
    --disable-pipewire  disable PipeWire audio output [autodetect]
    --enable-sndio      enable sndio audio input/output [disable]
  ...
  video outputs:
    ...
    --disable-sixel     disable Sixel [autodetect]
...
searching package graphite2 ...
getting graphite2-1.3.13_1.darwin_18.x86_64.tbz2 ...
verifying file integrity of graphite2-1.3.13_1.darwin_18.x86_64.tbz2 ...
installing graphite2 ...
searching package gobject-introspection ...
getting gobject-introspection-1.72.0_0.darwin_18.x86_64.tbz2 ...
verifying file integrity of gobject-introspection-1.72.0_0.darwin_18.x86_64.tbz2 ...
installing gobject-introspection ...
searching package py310-mako ...
getting py310-mako-1.2.0_0.darwin_18.noarch.tbz2 ...
verifying file integrity of py310-mako-1.2.0_0.darwin_18.noarch.tbz2 ...
installing py310-mako ...
searching package py310-setuptools ...
getting py310-setuptools-62.5.0_0.darwin_18.noarch.tbz2 ...
verifying file integrity of py310-setuptools-62.5.0_0.darwin_18.noarch.tbz2 ...
installing py310-setuptools ...
searching package python310 ...
getting python310-3.10.5_0+lto+optimizations.darwin_18.x86_64.tbz2 ...
verifying file integrity of python310-3.10.5_0+lto+optimizations.darwin_18.x86_64.tbz2 ...
